...
//                                config.setScanLineColor(R.color.colorAccent);//设置扫描线的颜色 默认白色
                        ...
                        .onDenied(new Action() {
                            ...
                            public void onAction(List<String> permissions) {
                                ...
                                Toast.makeText(MainActivity.this, "Doesn't have allowance, pls allowed to use camera", Toast.LENGTH_LONG).show();
                            }
                        }).start();
            ...
            case R.id.encodeBtn:
                ...
                if (TextUtils.isEmpty(contentEtString)) {
                    Toast.makeText(this, "Please input strings u want for your QR codes", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_SCAN && resultCode == RESULT_OK) {
            if (data != null) {
                ...
                result.setText("Scanned result ：" + content);
            }
        }
